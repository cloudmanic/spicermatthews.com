...
- `npx tailwindcss build -i resources/css/style.css -o static/css/build.css --watch` is useful to rebuild whenever we update the html. Typically just open in another terminal.
